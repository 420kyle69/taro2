 ...
 */
var TaroAnimationComponent = TaroEventingClass.extend({
	classId: 'TaroAnimationComponent',
	...
	start: function (animId, options) {
		if (this._anims) {
			...
			if (anim) {
				anim.currentDelta = 0;
				anim.currentLoop = 0;
				anim.startTime = taro._currentTime;
