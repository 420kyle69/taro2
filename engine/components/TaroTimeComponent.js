var TaroTimeComponent = TaroEventingClass.extend({
	classId: 'TaroTimeComponent',
	componentId: 'time',
	...
	_update: function () {
		// Get the taro tick delta and tell our timers / intervals that an update has occurred
		var self = taro.time;
