 ...
 */
var TaroAudioComponent = TaroEventingClass.extend({
	classId: 'TaroAudioComponent',
	componentId: 'audio',
	...
	play: function (id) {
		...
		if (audio) {
			if (audio.prototype.play) {
				...
				this.log('Trying to play audio with id "" but object with this id is not an TaroAudio instance, or does not implement the .play() method!', 'warnign');
			}
		}
	}
});
