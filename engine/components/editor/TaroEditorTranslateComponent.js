 ...
 */
var TaroEditorTranslateComponent = TaroEventingClass.extend({
	classId: 'TaroEditorTranslateComponent',
	...
	_mouseDown: function (event) {
		if (!this._opStarted && this._enabled && this._targetEntity) {
			...
			document.getElementById('taroSgEditorStatus').innerHTML = `X: ${this._targetEntity._translate.x} Y:${this._targetEntity._translate.y}`;
		}
	},
