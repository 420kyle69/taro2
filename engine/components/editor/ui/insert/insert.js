var UiTextureEditor = TaroEventingClass.extend({
	...
	init: function () {
		var self = this;
		taro.requireStylesheet(`${taroRoot}components/editor/ui/insert/insert.css`);
	...
	ready: function () {
		...
		taro.editor.ui.menus.addMenuGroup('insertMenu', 'objects');
		taro.editor.ui.menus.addMenuItem('insertMenu', 'objects', {
			id: 'insertDialog',
			icon: 'none',
			text: 'Insert Object...',
			action: 'taro.editor.ui.insert.show();'
		});
	},
