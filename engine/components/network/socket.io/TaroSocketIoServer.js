var TaroSocketIoServer = {
	...
	start: function (data, callback) {
		...
		this.define('_taroRequest', function () { self._onRequest.apply(self, arguments); });
		this.define('_taroResponse', function () { self._onResponse.apply(self, arguments); });
		this.define('_taroNetTimeSync', function () { self._onTimeSync.apply(self, arguments); });
...
if (typeof (module) !== 'undefined' && typeof (module.exports) !== 'undefined') { module.exports = TaroSocketIoServer; }
