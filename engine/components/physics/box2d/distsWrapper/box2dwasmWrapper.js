...
const box2dwasmWrapper = {
    init: function (component) {
        return __awaiter(this, void 0, void 0, function* () {
            const box2D = yield box2dwasm();
            ...
            component.tryRecordLeak = (p) => recordLeak(p);
            ...
            component.b2World.prototype.rayCast = (start, end, callback) => {
    ...
    createJoint: function (self, entityA, entityB, anchorA, anchorB) {
        ...
        if (entityA && entityA.body && entityB && entityB.body &&
            ...
            if (aBody.jointType == 'revoluteJoint') {
                let joint_def = self.recordLeak(new self.b2RevoluteJointDef());
             ...
             {
                let joint_def = self.recordLeak(new self.b2WeldJointDef());
