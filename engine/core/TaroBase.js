...
taroVersion = 'v1.6.0@2015-04-29.001';
...
if (taroConfig.debug._node) {
	taroConfig.debug._util = require('util');
}
...
/**
 * Augments all objects with the tween() method. Creates a new TaroTween
