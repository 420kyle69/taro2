 ...
 * (TaroFontSheet) or native font and render text.
 */
var TaroFontEntity = TaroUiEntity.extend({
	classId: 'TaroFontEntity',

	init: function () {
		TaroUiEntity.prototype.init.call(this);
	...
	/**
	 * Extends the TaroUiEntity.width() method and if the value being
	...
	width: function (val, lockAspect, modifier, noUpdate) {
		...
		var retVal = TaroUiEntity.prototype.width.call(this, val, lockAspect, modifier, noUpdate);
	...
	/**
	 * Extends the TaroUiEntity.height() method and if the value being
	...
	height: function (val, lockAspect, modifier, noUpdate) {
		...
		return TaroUiEntity.prototype.height.call(this, val, lockAspect, modifier, noUpdate);
	},
	...
	nativeFont: function (val) {
		if (val !== undefined) {
			...
			var tex = new TaroTexture(TaroFontSmartTexture);
			this.texture(tex);
	...
	measureTextWidth: function (text) {
		...
		// Both TaroFontSheet and the TaroFontSmartTexture have a method
	...
	tick: function (ctx) {
		...
		TaroUiEntity.prototype.tick.call(this, ctx);
	},
	...
	_stringify: function () {
		...
		var str = TaroUiEntity.prototype._stringify.call(this); var i;
...
if (typeof (module) !== 'undefined' && typeof (module.exports) !== 'undefined') { module.exports = TaroFontEntity; }
