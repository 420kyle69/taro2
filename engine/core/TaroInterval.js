 ...
 */
var TaroInterval = TaroEventingClass.extend({
	classId: 'TaroInterval',
	...
	init: function (method, interval) {
		...
		this._time = 0;
		this._started = taro._currentTime;
...
if (typeof (module) !== 'undefined' && typeof (module.exports) !== 'undefined') { module.exports = TaroInterval; }
