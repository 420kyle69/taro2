 ...
 */
var TaroParticleEmitter = TaroUiEntity.extend({
	classId: 'TaroParticleEmitter',
	TaroParticleEmitter: true,
	...
	init: function () {
		...
		this._started = false;
		this._particles = [];
		this.texture = new TaroTexture(`${assetsProvider}/assets/particles/Rectangle.js`);
	...
	*/
	 ...
	 */
	tick: function (ctx) {
		this._currentDelta += taro._tickDelta;
				...
				if (this._currentDelta >= this._particlesPerTimeVector) {
					...
					if (particleCount) {
						while (particleCount--) {
							...
							// console.log("tileOccupied", taro.map.isTileOccupied(translateX, translateY, 5, 5))
...
if (typeof (module) !== 'undefined' && typeof (module.exports) !== 'undefined') { module.exports = TaroParticleEmitter; }
