/**
 * Creates a new path node for use with the TaroPathFinder class.
 */
var TaroPathNode = TaroPoint3d.extend({
	classId: 'TaroPathNode',
	...
	init: function (x, y, g, moveCost, h, parent, direction) {
		this.z = 0; // Compat with TaroPoint3d
...
if (typeof (module) !== 'undefined' && typeof (module.exports) !== 'undefined') { module.exports = TaroPathNode; }
