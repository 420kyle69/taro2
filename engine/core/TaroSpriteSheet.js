 ...
 * arbitrary sections.
 */
var TaroSpriteSheet = TaroTexture.extend({
	classId: 'TaroSpriteSheet',
	TaroSpriteSheet: true,

	init: function (url, cells) {
		this._spriteCells = cells;

		TaroTexture.prototype.init.call(this, url);
	},
...
if (typeof (module) !== 'undefined' && typeof (module.exports) !== 'undefined') { module.exports = TaroSpriteSheet; }
