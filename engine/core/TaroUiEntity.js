 ...
 * than standard TaroEntity instances so only use them if an TaroEntity
 * won't do the job.
 */
var TaroUiEntity = TaroEntity.extend([
	{ extension: TaroUiStyleExtension, overwrite: true },
	{ extension: TaroUiPositionExtension, overwrite: true }
], {
	classId: 'TaroUiEntity',
	...
	cell: function (val) {
		var ret = TaroEntity.prototype.cell.call(this, val);
	...
	mount: function (obj) {
		var ret = TaroEntity.prototype.mount.call(this, obj);
	...
	tick: function (ctx, dontTransform) {
		if (taro.isClient && !taro.client.uiEntityRenderEnabled) return;
		if (!this._hidden && this._inView && (!this._parent || (this._parent._inView)) && !this._streamJustCreated) {
			...
			TaroEntity.prototype.tick.call(this, ctx, true);
		}
	},
...
if (typeof (module) !== 'undefined' && typeof (module.exports) !== 'undefined') { module.exports = TaroUiEntity; }
