 ...
 */
var TaroUiMenu = TaroUiElement.extend({
	classId: 'TaroUiMenu',
...
var TaroUiMenuItem = TaroUiElement.extend({
	classId: 'TaroUiMenuItem',
	...
	menuData: function (menuData) {
		if (menuData !== undefined) {
			...
			this._labelEntity = new TaroFontEntity()
				.id(`${this.id()}_label`)
	...
	open: function () {
		if (this._menuData.items) {
			this._childMenu = new TaroUiMenu()
