...
var TaroUiTextBox = TaroUiElement.extend({
	classId: 'TaroUiTextBox',
	...
	init: function () {
		...
		this._fontEntity = new TaroFontEntity()
			.left(5)
			.middle(0)
			.textAlignX(0)
			.textAlignY(0)
		...
		this.on('mouseDown', function () { taro.input.stopPropagation(); });
	...
	_mounted: function () {
		...
		TaroUiElement.prototype._mounted.call(this);
	}
});
