 ...
 * at free will.
 */
var TaroUiTooltip = TaroUiElement.extend({
	classId: 'TaroUiTooltip',
	...
	init: function (parent, mountEntity, width, height, content) {
		...
		var self = this;
		this.titleBox = new TaroUiElement()
			.left(0)
			.top(0)
			.width(width)
			.height(30)
		...
		this.textBox = new TaroUiElement()
			.left(0)
			.top(30)
			.width(width)
			.height(height - 30)
		...
		this.fontEntityTitle = new TaroFontEntity()
			.left(5)
			.top(-4)
			.textAlignX(0)
			.textAlignY(0)
		...
		this.fontEntityText = new TaroFontEntity()
			.left(5)
			.top(0)
			.textAlignX(0)
			.textAlignY(0)
	...
	width: function (px, lockAspect, modifier, noUpdate) {
		...
		val = TaroUiElement.prototype.width.call(this, px, lockAspect, modifier, noUpdate);
	...
	height: function (px, lockAspect, modifier, noUpdate) {
		...
		// Call the main super class method
		val = TaroUiElement.prototype.height.call(this, px, lockAspect, modifier, noUpdate);
	...
	_mousemove: function (event) {
		...
		tt.translateTo(event.taroX - mountPos.x + tt._bounds2d.x2 + 10, event.taroY - mountPos.y + tt._bounds2d.y2, 0);
		tt.updateUiChildren();
	},
