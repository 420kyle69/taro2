...
var Combinator = /** @class */ (function () {
    function Combinator() {
    }
    Combinator.increase = function (start, end, step) {
    ...
    Combinator.decrease = function (start, end, step) {
        if (step === void 0) { step = 1; }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    Combinator.range = function (start, end, step) {
        if (step === void 0) { step = 1; }
        if (start < end) {
    ...
    Combinator.spread = function (start, end, step) {
        if (step === void 0) { step = 1; }
        if (start === end) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _y = Combinator.spread(0, rightIndex);
                    distance = 0;
                    _a.label = 1;
                case 1:
                    if (!true) return [3 /*break*/, 8];
                ...
                case 2:
                    ...
                    _x = Combinator.spread(0 + radius - chord, rightIndex - radius + chord);
                    _a.label = 3;
                case 3:
                    if (!true) return [3 /*break*/, 7];
                    valueX = _x.next();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [3 /*break*/, 8];
                case 2:
                    _x = Combinator.spread(0 + Math.floor(distance), rightIndex - Math.floor(distance));
                    _a.label = 3;
                case 3:
                    if (!true) return [3 /*break*/, 7];
                    valueX = _x.next();
