...
var PhaserPalette = /** @class */ (function (_super) {
    ...
    function PhaserPalette(scene, tileset, rexUI) {
        ...
        _this.scene.scale.on(Phaser.Scale.Events.RESIZE, function () {
            ...
            toolButtonsContainer.x = _this.camera.x + 93;
        });
        new PhaserPaletteButton(_this, '+', null, 0, -31, 30, scrollBarContainer, _this.zoom.bind(_this), -1);
        new PhaserPaletteButton(_this, '-', null, 31, -31, 30, scrollBarContainer, _this.zoom.bind(_this), 1);
        ...
        new PhaserPaletteButton(_this, 'tiles', null, 0, -31, 120, layerButtonsContainer, _this.toggle.bind(_this));
        _this.layerButtons = [];
        _this.layerButtons.push(new PhaserPaletteButton(_this, 'floor', null, 0, -93, 120, layerButtonsContainer, _this.switchLayer.bind(_this), 0), new PhaserPaletteButton(_this, 'floor2', null, 0, -124, 120, layerButtonsContainer, _this.switchLayer.bind(_this), 1), new PhaserPaletteButton(_this, 'walls', null, 0, -155, 120, layerButtonsContainer, _this.switchLayer.bind(_this), 2), new PhaserPaletteButton(_this, 'trees', null, 0, -186, 120, layerButtonsContainer, _this.switchLayer.bind(_this), 3));
        ...
        toolButtonsContainer.x = _this.camera.x + 93;
        toolButtonsContainer.y = _this.camera.y;
        toolButtonsContainer.width = 310;
        toolButtonsContainer.height = 50;
        new PhaserPaletteButton(_this, '_', 'eraser', 0, -31, 30, toolButtonsContainer, _this.emptyTile.bind(_this));
        _this.toolButtons = [];
        _this.toolButtons.push(new PhaserPaletteButton(_this, '.', null, 62, -31, 30, toolButtonsContainer, _this.selectSingle.bind(_this)), new PhaserPaletteButton(_this, '[]', null, 93, -31, 30, toolButtonsContainer, _this.selectArea.bind(_this)));
