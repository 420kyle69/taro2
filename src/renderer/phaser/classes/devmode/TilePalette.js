class TilePalette extends Phaser.GameObjects.Container {
    constructor(scene, tileset, rexUI, commandController) {
        super(scene);
        this.scene = scene;
        ...
        const camera = this.camera = this.scene.cameras.add(this.scene.sys.game.canvas.width - paletteWidth - 40, this.scene.sys.game.canvas.height - paletteHeight - 40, paletteWidth, paletteHeight)
