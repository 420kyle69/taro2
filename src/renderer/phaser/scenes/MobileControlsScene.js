class MobileControlsScene extends PhaserScene {
    ...
    init() {
        ...
        taro.mobileControls.on('add-control', (key, x, y, settings, abilityId, ability) => {
            var _a;
            switch (key) {
                case 'movementWheel':
                case 'lookWheel':
                ...
                default:
                    ...
                    const uiScene = taro.renderer.scene.getScene('Ui');
                    let buttonExist = false;
                    Object.values((_a = uiScene === null || uiScene === void 0 ? void 0 : uiScene.phaserButtonBar) === null || _a === void 0 ? void 0 : _a.buttons).forEach((button) => {
                        if (button.key === key) {
                            button.x = relativeX;
                            button.y = relativeY;
                            buttonExist = true;
        ...
        let resized = false;
        taro.mobileControls.on('orientationchange', (e) => {
        ...
        taro.mobileControls.on('visible', (value) => {
